                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <table id="myTable" class="table dt-responsive nowrap w-100 dataTable no-footer dtr-inline" aria-describedby="basic-datatable_info" style="position: relative; width: 1490px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" style="width: 184.8px;" aria-label="Office: activate to sort column ascending">Name</th>
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" style="width: 184.8px;" aria-label="Office: activate to sort column ascending">Email</th>
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" style="width: 184.8px;" aria-label="Office: activate to sort column ascending">Payment</th>
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" style="width: 184.8px;" aria-label="Office: activate to sort column ascending">Confirm Paid</th>
                                                ...
                                                @foreach($users as $item)
                                                    <tr class="odd">
                                                        ...
                                                        <td>{{ $item->email }}</td>
                                                        <td>{!! $item->payment() !!}</td>
                                                        <td><a href="{{ route('admin.paid', $item->id) }}" class="btn btn-primary">Confirm</a></td>
                                                        <td>
                                                            <form method="POST" action="{!! route('admin.delete_user', $item->id) !!}" accept-charset="UTF-8">
