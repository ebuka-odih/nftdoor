                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="floating-preview">
                                ...
                                <form action="{{ route('admin.toolbox.update', $toolbox->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method("PATCH")
                                    <div class="row">
                                        @if ($errors->any())
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="title" value="{{ old('title', optional($toolbox)->title) }}" class="form-control form-control" id="floatingInput" placeholder="Bored Ape">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <img class="mt-2" height="70" width="70" src="{{ asset('toolbox/'.$toolbox->featured_image) }}" alt="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <textarea class="ckeditor form-control" cols="10" rows="10" name="body">
                                                    {{ old('body', optional($toolbox)->body) }}
                                                </textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 mt-4">
