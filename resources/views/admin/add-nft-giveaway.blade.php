                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="floating-preview">
                                ...
                                <form action="{{ route('admin.nft-giveaway.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        @if ($errors->any())
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" name="start_date" class="form-control form-control" id="floatingInput" placeholder="0.2">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="end_date" class="form-control" id="floatingPassword" placeholder="100">
                                                </div>
                                            </div>
                                        </div>
