...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            ...
            <div class="col-12">
                <div class="col-md-6">
                    <a href="{{ route('admin.category.create') }}" class="btn btn-primary mb-4">Add New</a>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <table id="myTable" class="table dt-responsive nowrap w-100 dataTable no-footer dtr-inline" aria-describedby="basic-datatable_info" style="position: relative; width: 1490px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" style="width: 184.8px;" aria-label="Office: activate to sort column ascending">Slug</th>
                                                ...
                                                @foreach($category as $item)
                                                    <tr class="odd">
                                                        ...
                                                        <td>{{ $item->slug }}</td>
                                                        <td>
                                                            <form method="POST" action="{!! route('admin.category.destroy', $item->id) !!}" accept-charset="UTF-8">
                                                                ...
                                                                <div class="btn-group btn-group-xs pull-right" role="group">
                                                                    ...
                                                                    <button data-toggle="tooltip" data-placement="top" type="submit" class="btn  btn-sm btn-danger" onclick="return confirm(&quot;Delete Category?&quot;)">
