...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            ...
            <div class="col-12">
                <div class="col-md-6">
                    <a href="{{ route('admin.nft-giveaway.create') }}" class="btn btn-primary mb-4">Add New</a>

                </div>
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4">NFT Giveaway</h4>
                        <!-- end nav-->
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <table id="myTable" class="table dt-responsive nowrap w-100 dataTable no-footer dtr-inline" aria-describedby="basic-datatable_info" style="position: relative; width: 1490px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" style="width: 184.8px;" aria-label="Office: activate to sort column ascending">Start Date</th>
                                                    <th class="sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" style="width: 184.8px;" aria-label="Office: activate to sort column ascending">Ending Date</th>
                                                ...
                                                @foreach($nft_giveaway as $item)
                                                    <tr class="odd">
                                                        ...
                                                        <td>{{ $item->name }}</td>
                                                        <td><img height="100" width="100" src="{{ asset('nft-giveaway/'.$item->featured_image) }}" alt=""></td>
                                                        <td>{{ $item->start_date }}</td>
                                                        <td>{{ $item->end_date }}</td>
                                                        <td>
                                                            <a href="{{ route('admin.nft-giveaway.show', $item->id) }}" class="btn btn-sm btn-secondary">view</a>
                                                            <a href="{{ route('admin.nft-giveaway.edit', $item->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                        </td>
                                                        <td>
                                                            <form method="POST" action="{!! route('admin.nft-giveaway.destroy', $item->id) !!}" accept-charset="UTF-8">
